...
@DataJpaTest //by default starts an embedded dababase.
@Transactional(propagation = Propagation.NOT_SUPPORTED)  //disable automatic rollback after each test case
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) //disable embedded dababase
